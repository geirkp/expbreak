...
\begin{table}[]
\caption{\textit{Maximum runup measurements where $A$ incident wave amplitude,$A_m$ is the measured amplitude, $r$ is the runup in the direction along the beach, R is the vertical projection of the maximum runup, t is the time corresponding to max runup and $e$ is the estimated error in the measurement }}
\centering
...
\textit{FOV II}  & 0.98   &    0.88   & 1.32                      \\
\textit{FOV III} &  1.97   &    0.88  & 1.48                            \\
\textit{FOV IV}  & 2.82    &   1.35  & 1.45                 \\
\end{tabular}
\label{tab:irr}
\end{table}
