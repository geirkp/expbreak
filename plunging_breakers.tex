...
An acoustic wave gauge (ultra Banner U-Gage S18U, sample frequency of 200Hz) measured the wave height at the toe of the beach and the amplitudes were found to
 be $A/H=(0.09865, 0.1191, 0.1977, 0.2959, 0.3939, 0.4863)$. \sidenote{Sett inn riktig amplitude som er gitt av BIM}  
...
\begin{figure}
        ...
        ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc.
          %(or a blank line to force the subfigure onto a new line)
                \includegraphics[width=0.46\textwidth]{./Figures/BIM/case10_BIM_PIV_FOV3.eps}
                \includegraphics[width=0.46\textwidth]{./Figures/BIM/case10_BIM_PIV_FOV4.eps}
