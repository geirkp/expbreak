...
In fact, in Figure \ref{fig:max_runup} we observe transverse variations in the field og views in the experiments and the average FOV
runup height for the smallest wave $(\alpha=0.10)$ is 4.10, \marginpar{Endring} which is more than 3.76\% smaller than the maximum one, which implies that real difference between theoretical and computed
