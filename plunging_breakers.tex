        ...
        ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc.
          %(or a blank line to force the subfigure onto a new line)
               \includegraphics[width=0.40\textwidth]{./Figures/BIM/case50_BIM_PIV_FOV3.eps}
                ...
                \caption{\textit{Colors: blue, cyan and green correspond to run 1,2 and 3. \\Upper Left: Velocity profiles from FOV I x=8.7cm t=[6.12, 6.34, 6.50, 6.69, 6.84, 7.00, 7.27, 7.45]s\\
...
Inspection of movies of the front of the swash tongue from FOV IV (furthest up the beach) shows that a systematic swirling effect were present in the front of the swash tongue for $\alpha=0.50$.  Particle Tracking Velocimetry (PTV) have been utilized on images captured immediately after the arrival of the swash tongue, to investigate this phenomenon. So for each image pair, the velocity for all the particles whitin a distance of 0.05cm from a given evaluation point (x,y)=(120,0.3)cm are plotted. Figure \ref{fig:wave_in_time} shows how the velocities vary as a function of time. Superimposed a steady deceleration of the fluid there is an 
oscillation.
