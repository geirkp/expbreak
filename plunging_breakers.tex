...
\begin{figure}[]
\centering
\scalebox{1}[-1]{\includegraphics[angle=175,width=0.7\textwidth]{./Figures/BUBBLE/new_jan_bilde_bub.eps}}
%http://commons.wikimedia.org/wiki/File:Breaking_wave_types.gif
...
\begin{figure}[]
\centering
\includegraphics[angle=5.1,width=0.5\textwidth]{./Figures/BUBBLE/bubble_30_run1.eps}
\includegraphics[angle=5.1,width=0.5\textwidth]{./Figures/BUBBLE/bubble_30_run2.eps}
\includegraphics[angle=5.1,width=0.5\textwidth]{./Figures/BUBBLE/bubble_30_run3.eps}
%http://commons.wikimedia.org/wiki/File:Breaking_wave_types.gif
...
\begin{figure}[]
\centering
\includegraphics[angle=5.1,width=0.5\textwidth]{./Figures/BUBBLE/bubble_50_run1.eps}
\includegraphics[angle=5.1,width=0.5\textwidth]{./Figures/BUBBLE/bubble_50_run2.eps}
\includegraphics[angle=5.1,width=0.5\textwidth]{./Figures/BUBBLE/bubble_50_run3.eps}
%http://commons.wikimedia.org/wiki/File:Breaking_wave_types.gif
