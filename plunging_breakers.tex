...
in  dropouts. The surface elevation measurements are in agreement with computed surface elevation from  the BIM simulatitions.\sidenote{Must explain why the dropouts are there and how reflection is corrected for.}
